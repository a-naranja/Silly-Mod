...
public class silly_skill5 extends SCBaseSkillPlugin {
    @Override
    ...
    public void addTooltip(SCData scData, TooltipMakerAPI tt) {
        tt.addPara("Increases damage dealt against Cruisers and Capital ships by 20%%",0f, Misc.getHighlightColor(),Misc.getHighlightColor());
    }
    @Override
